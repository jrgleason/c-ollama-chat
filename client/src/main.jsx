...
function App() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-surface-dark to-surface-bg text-white p-8">
      <header className="max-w-4xl mx-auto mb-6">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-4">
            <a href="https://github.com/yourusername/c-ollama-chat" target="_blank" rel="noreferrer" className="text-sm bg-surface px-3 py-1 rounded-md hover:bg-surface-light transition-colors">
              GitHub
            </a>
            <AuthButton />
          </div>
      ...
      <main className="max-w-4xl mx-auto bg-surface-bg rounded-lg shadow-xl overflow-hidden h-[calc(100vh-12rem)]">
        <ChatInterface />
      </main>
