...
export function ChatInterface() {
    ...
    return (
        <div className="flex flex-col h-full">      {auth0Loading ? (
            ...
            {showDebug && (
                <div
                    className="fixed bottom-4 right-4 w-96 max-h-64 bg-surface-dark border border-surface rounded-lg shadow-2xl z-50">
                    ...
                    <div className="p-3">            <pre
                        className="text-xs text-secondary overflow-y-auto max-h-40 whitespace-pre-wrap">
              {debugInfo}
            </pre>
                        <button
